...
contract TestGhoBucketSteward is TestGhoBase, GhoStewardProcedure {
    function setUp() public {
        ...
        GHO_BUCKET_STEWARD = GhoBucketSteward(
            _deployGhoBucketSteward({owner: SHORT_EXECUTOR, ghoToken: address(GHO_TOKEN), riskCouncil: RISK_COUNCIL})
        );
    ...
    function testConstructor() public view {
        ...
        uint40 facilitatorTimelock = GHO_BUCKET_STEWARD.getFacilitatorBucketCapacityTimelock(controlledFacilitators[0]);
    ...
    function testUpdateFacilitatorBucketCapacity() public {
        ...
        GHO_BUCKET_STEWARD.updateFacilitatorBucketCapacity(address(GHO_FLASH_MINTER), newBucketCapacity);
    ...
    function testUpdateFacilitatorBucketCapacityTimelock() public {
        ...
        GHO_BUCKET_STEWARD.updateFacilitatorBucketCapacity(
            address(GHO_FLASH_MINTER), uint128(currentBucketCapacity) + 1
        );
        uint40 timelock = GHO_BUCKET_STEWARD.getFacilitatorBucketCapacityTimelock(address(GHO_FLASH_MINTER));
    ...
    function testUpdateFacilitatorBucketCapacityAfterTimelock() public {
        ...
        vm.prank(RISK_COUNCIL);
        GHO_BUCKET_STEWARD.updateFacilitatorBucketCapacity(address(GHO_FLASH_MINTER), newBucketCapacityAfterTimelock);
        (uint256 capacity,) = GHO_TOKEN.getFacilitatorBucket(address(GHO_FLASH_MINTER));
    ...
    function testRevertUpdateFacilitatorBucketCapacityIfUpdatedTooSoon() public {
        ...
        GHO_BUCKET_STEWARD.updateFacilitatorBucketCapacity(
            address(GHO_FLASH_MINTER), uint128(currentBucketCapacity) + 2
        );
    }
    ...
    function testRevertUpdateFacilitatorBucketCapacityNoChange() public {
        ...
        GHO_BUCKET_STEWARD.updateFacilitatorBucketCapacity(address(GHO_FLASH_MINTER), uint128(currentBucketCapacity));
    }
    ...
    function testRevertUpdateFacilitatorBucketCapacityIfFacilitatorNotInControl() public {
        ...
        GHO_BUCKET_STEWARD.updateFacilitatorBucketCapacity(address(GHO_GSM_4626), uint128(currentBucketCapacity) + 1);
    }
    ...
    function testRevertUpdateFacilitatorBucketCapacityIfStewardLostBucketManagerRole() public {
        ...
        vm.expectRevert(AccessControlErrorsLib.MISSING_ROLE(GHO_TOKEN_BUCKET_MANAGER_ROLE, address(GHO_BUCKET_STEWARD)));
        vm.prank(RISK_COUNCIL);
        GHO_BUCKET_STEWARD.updateFacilitatorBucketCapacity(
            address(GHO_FLASH_MINTER), uint128(currentBucketCapacity) + 1
        );
    ...
    function testRevertUpdateFacilitatorBucketCapacityIfMoreThanDouble() public {
        ...
        GHO_BUCKET_STEWARD.updateFacilitatorBucketCapacity(
            address(GHO_FLASH_MINTER), uint128(currentBucketCapacity * 2) + 1
        );
    }
