...
contract TestGsmFullFlow is TestGhoBase {
    function testGsmFull() public {
...

        {
            ...
            assertEq(
                limit - used, reserve.getLimit(address(gsm)) - ghoBought, "Unexpected amount of available capacity"
            );
        }
...

        {
            ...
            assertEq(limit - used, reserve.getLimit(address(gsm)), "Unexpected amount of available capacity");
        }
