...
contract Constants {
    ...
    bytes32 public constant GHO_TOKEN_FACILITATOR_MANAGER_ROLE = keccak256("FACILITATOR_MANAGER_ROLE");
    ...
    bytes32 public constant GSM_BUY_ASSET_WITH_SIG_TYPEHASH = keccak256(
        "BuyAssetWithSig(address originator,uint256 minAmount,address receiver,uint256 nonce,uint256 deadline)"
    );
    bytes32 public constant GSM_SELL_ASSET_WITH_SIG_TYPEHASH = keccak256(
