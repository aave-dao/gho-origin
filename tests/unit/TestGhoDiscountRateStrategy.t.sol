...
contract TestGhoDiscountRateStrategy is TestGhoBase {
  ...
  function testDebtBalanceBelowThreshold() public view {
  ...
  function testDiscountBalanceBelowThreshold() public view {
    uint256 result = GHO_DISCOUNT_STRATEGY.calculateDiscountRate(
  ...
  function testEqualDiscountedTokenThanDebtBalance() public view {
    assertGe(
  ...
  function testMoreDiscountedTokenThanDebtBalance() public view {
    assertGe(
      GHO_DISCOUNT_STRATEGY.GHO_DISCOUNTED_PER_DISCOUNT_TOKEN(),
      1e18,
      'Unexpected low value for discount token conversion'
  ...
  function testFuzzMinBalance(uint256 debtBalance, uint256 discountTokenBalance) public view {
    vm.assume(
