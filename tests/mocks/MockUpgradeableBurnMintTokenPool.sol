...
import {
    Initializable
} from "src/contracts/dependencies/solidity-utils/src/contracts/transparent-proxy/Initializable.sol";
import {
    EnumerableSet
...
contract MockUpgradeableBurnMintTokenPool is Initializable {
    ...
    function initialize(address newOwner, address[] memory allowlist, address router, uint256 bridgeLimit)
        public
        virtual
        initializer
    {
