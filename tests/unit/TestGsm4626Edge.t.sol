...
contract TestGsm4626Edge is TestGhoBase {
    ...
    function testOngoingExposureSellAsset() public {
        ...
        uint256 ghoBought = _sellAsset(GHO_GSM_4626, USDX_4626_TOKEN, USDX_TOKEN, ALICE, sellAssetAmount);
        ...
        assertEq(GHO_GSM_4626.getAvailableUnderlyingExposure(), DEFAULT_GSM_USDX_EXPOSURE - calcExposure);
        assertEq(GHO_GSM_4626.getAvailableLiquidity(), calcExposure);
        assertEq(USDX_4626_TOKEN.previewRedeem(USDX_4626_TOKEN.balanceOf(address(GHO_GSM_4626))), sellAssetAmount);
        ...
        assertEq(GHO_GSM_4626.getAvailableUnderlyingExposure(), DEFAULT_GSM_USDX_EXPOSURE - calcExposure);
        assertEq(GHO_GSM_4626.getAvailableLiquidity(), calcExposure);
        assertEq(USDX_4626_TOKEN.previewRedeem(USDX_4626_TOKEN.balanceOf(address(GHO_GSM_4626))), sellAssetAmount * 2);
        ...
        assertEq(GHO_GSM_4626.getAvailableLiquidity(), calcExposure);
        assertEq(
            USDX_4626_TOKEN.previewRedeem(USDX_4626_TOKEN.balanceOf(address(GHO_GSM_4626))), sellAssetAmount * 2 * 2
        );
    ...
    function testExposureLimitWithSharpExchangeRate() public {
        ...
        assertEq(USDX_4626_TOKEN.previewRedeem(USDX_4626_TOKEN.balanceOf(ALICE)), DEFAULT_GSM_USDX_EXPOSURE);
    ...
    function testDistributeYieldToTreasury() public {
        ...
        uint256 backingBefore = USDX_4626_TOKEN.previewRedeem(USDX_4626_TOKEN.balanceOf(address(GHO_GSM_4626)));
        ...
        uint256 backingAfter = USDX_4626_TOKEN.previewRedeem(USDX_4626_TOKEN.balanceOf(address(GHO_GSM_4626)));
        assertEq(backingAfter, backingBefore * 2);

        // Distribute fees and yield in form of GHO to the treasury
        uint256 totalBackedGho =
            GHO_GSM_4626_FIXED_PRICE_STRATEGY.getAssetPriceInGho(GHO_GSM_4626.getAvailableLiquidity(), true);
        ...
        emit FeesDistributedToTreasury(
            TREASURY, address(GHO_TOKEN), GHO_TOKEN.balanceOf(address(GHO_GSM_4626)) + DEFAULT_GSM_GHO_AMOUNT
        );
        ...
        assertEq(GHO_TOKEN.balanceOf(TREASURY), fee + DEFAULT_GSM_GHO_AMOUNT, "Unexpected GHO balance in treasury");

        totalMintedGho = GHO_GSM_4626.getUsed();
        assertEq(
            totalBackedGho,
            GHO_GSM_4626_FIXED_PRICE_STRATEGY.getAssetPriceInGho(GHO_GSM_4626.getAvailableLiquidity(), false)
        );
    ...
    function testDistributeYieldToTreasuryWithLosses() public {
        ...
        _changeExchangeRate(USDX_4626_TOKEN, USDX_TOKEN, DEFAULT_GSM_USDX_AMOUNT / 2, false);
        assertEq(
            USDX_4626_TOKEN.previewRedeem(USDX_4626_TOKEN.balanceOf(address(GHO_GSM_4626))), DEFAULT_GSM_USDX_AMOUNT / 2
        );
    ...
    function testDistributeYieldToTreasuryWithExcessExceedingCapacity() public {
        ...
        // Inflate exchange rate
        _changeExchangeRate(USDX_4626_TOKEN, USDX_TOKEN, DEFAULT_GSM_USDX_AMOUNT, true);
        (uint256 excessBeforeDistribution, uint256 deficitBeforeDistribution) = GHO_GSM_4626.getCurrentBacking();
        ...
        assertEq(GHO_TOKEN.balanceOf(address(TREASURY)), ongoingAccruedFees + margin, "Unexpected Treasury GHO balance");

        (uint256 excessAfterDistribution, uint256 deficitAfterDistribution) = GHO_GSM_4626.getCurrentBacking();
        assertEq(
            excessAfterDistribution, excessBeforeDistribution - fee.percentMul(feePercentToMint), "Unexpected excess"
        );
    ...
    function testGetAccruedFeesWithHighExchangeRate() public {
        ...
        assertEq(USDX_TOKEN.balanceOf(ALICE), 0, "Unexpected final USDX balance");
        assertEq(GHO_TOKEN.balanceOf(ALICE), ghoOut, "Unexpected final GHO balance");
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM_4626)), ongoingAccruedFees, "Unexpected GSM GHO balance");
        assertEq(
            GHO_GSM_4626.getAvailableUnderlyingExposure(),
            DEFAULT_GSM_USDX_EXPOSURE - DEFAULT_GSM_USDX_AMOUNT,
            "Unexpected available underlying exposure"
    ...
    function testBuyAssetAtCapacityWithGain() public {
        ...
        ghoLevel = GHO_GSM_4626.getUsed();
        assertEq(ghoLevel, (DEFAULT_GSM_USDX_EXPOSURE / 4) * 1e12, "Unexpected GHO bucket level after final buy");
        (excess, deficit) = GHO_GSM_4626.getCurrentBacking();
