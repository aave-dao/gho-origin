...
contract TestGsm4626 is TestGhoBase {
    ...
    function testConstructor() public {
        Gsm4626 gsm =
            new Gsm4626(address(GHO_TOKEN), address(USDX_4626_TOKEN), address(GHO_GSM_4626_FIXED_PRICE_STRATEGY));
        assertEq(gsm.GHO_TOKEN(), address(GHO_TOKEN), "Unexpected GHO token address");
        assertEq(gsm.UNDERLYING_ASSET(), address(USDX_4626_TOKEN), "Unexpected underlying asset address");
        assertEq(gsm.PRICE_STRATEGY(), address(GHO_GSM_4626_FIXED_PRICE_STRATEGY), "Unexpected price strategy");
    }
    ...
    function testInitialize() public {
        ...
        Gsm4626 gsm = _deployGsm4626Proxy(
            address(USDX_4626_TOKEN), address(GHO_GSM_4626_FIXED_PRICE_STRATEGY), DEFAULT_GSM_USDX_EXPOSURE
        );
    ...
    function testSellAssetZeroFee() public {
        ...
        (uint256 assetAmount, uint256 ghoBought) = GHO_GSM_4626.sellAsset(DEFAULT_GSM_USDX_AMOUNT, ALICE);
        vm.stopPrank();
        ...
        assertEq(GHO_GSM_4626.getExposureCap(), DEFAULT_GSM_USDX_EXPOSURE, "Unexpected exposure capacity");
    }
    ...
    function testSellAsset() public {
        ...
        _mintVaultAssets(USDX_4626_TOKEN, USDX_TOKEN, ALICE, DEFAULT_GSM_USDX_AMOUNT);
        assertEq(USDX_4626_TOKEN.previewRedeem(USDX_4626_TOKEN.balanceOf(ALICE)), DEFAULT_GSM_USDX_AMOUNT);
        ...
        assertEq(GHO_GSM_4626.getAvailableLiquidity(), DEFAULT_GSM_USDX_AMOUNT, "Unexpected available liquidity");
        assertEq(GHO_GSM_4626.getExposureCap(), DEFAULT_GSM_USDX_EXPOSURE, "Unexpected exposure capacity");
    }
    ...
    function testRevertSellAssetTooMuchUnderlyingExposure() public {
        Gsm4626 gsm = _deployGsm4626Proxy(
            address(USDX_4626_TOKEN), address(GHO_GSM_4626_FIXED_PRICE_STRATEGY), uint128(DEFAULT_GSM_USDX_EXPOSURE - 1)
        );
    ...
    function testGetGhoAmountForSellAsset() public {
        (uint256 exactAssetAmount, uint256 ghoBought, uint256 grossAmount, uint256 fee) =
            GHO_GSM_4626.getGhoAmountForSellAsset(DEFAULT_GSM_USDX_AMOUNT);

        _sellAsset(GHO_GSM_4626, USDX_4626_TOKEN, USDX_TOKEN, ALICE, DEFAULT_GSM_USDX_AMOUNT);

        assertEq(
            DEFAULT_GSM_USDX_AMOUNT - USDX_4626_TOKEN.balanceOf(ALICE), exactAssetAmount, "Unexpected asset amount sold"
        );
        ...
        (uint256 assetAmount, uint256 exactGhoBought, uint256 grossAmount2, uint256 fee2) =
            GHO_GSM_4626.getAssetAmountForSellAsset(ghoBought);
    ...
    function testGetGhoAmountForSellAssetWithZeroAmount() public view {
        (uint256 exactAssetAmount, uint256 ghoBought, uint256 grossAmount, uint256 fee) =
            GHO_GSM_4626.getGhoAmountForSellAsset(0);
    ...
    function testBuyAssetZeroFee() public {
        ...
        assertEq(USDX_4626_TOKEN.balanceOf(BOB), DEFAULT_GSM_USDX_AMOUNT, "Unexpected final USDX balance");
        assertEq(GHO_TOKEN.balanceOf(ALICE), DEFAULT_GSM_GHO_AMOUNT, "Unexpected final GHO balance");
        assertEq(GHO_GSM_4626.getExposureCap(), DEFAULT_GSM_USDX_EXPOSURE, "Unexpected exposure capacity");
    }
    ...
    function testBuyAsset() public {
        ...
        assertEq(USDX_4626_TOKEN.balanceOf(BOB), DEFAULT_GSM_USDX_AMOUNT, "Unexpected final USDX balance");
        assertEq(GHO_TOKEN.balanceOf(ALICE), ghoOut, "Unexpected final GHO balance");
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM_4626)), sellFee + buyFee, "Unexpected GSM GHO balance");
        assertEq(
            GHO_GSM_4626.getAvailableUnderlyingExposure(),
    ...
    function testBuyAssetSendToOther() public {
        ...
        (uint256 assetAmount, uint256 ghoSold) = GHO_GSM_4626.buyAsset(DEFAULT_GSM_USDX_AMOUNT, CHARLES);
        vm.stopPrank();

        assertEq(ghoSold, DEFAULT_GSM_GHO_AMOUNT + buyFee, "Unexpected GHO amount sold");
        assertEq(assetAmount, DEFAULT_GSM_USDX_AMOUNT, "Unexpected asset amount bought");
        assertEq(USDX_4626_TOKEN.balanceOf(BOB), 0, "Unexpected final USDX balance");
        assertEq(USDX_4626_TOKEN.balanceOf(CHARLES), DEFAULT_GSM_USDX_AMOUNT, "Unexpected final USDX balance");
        assertEq(GHO_TOKEN.balanceOf(ALICE), ghoOut, "Unexpected final GHO balance");
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM_4626)), sellFee + buyFee, "Unexpected GSM GHO balance");
        assertEq(GHO_GSM_4626.getExposureCap(), DEFAULT_GSM_USDX_EXPOSURE, "Unexpected exposure capacity");
    }
    ...
    function testBuyThenSellAtMaximumBucketCapacity() public {
        ...
        assertEq(GHO_TOKEN.balanceOf(ALICE), DEFAULT_CAPACITY, "Unexpected Alice GHO balance after sell");
        ...
        assertEq(GHO_TOKEN.balanceOf(ALICE), DEFAULT_CAPACITY - 1e18, "Unexpected Alice GHO balance after buy");
        ...
        assertEq(GHO_TOKEN.balanceOf(ALICE), DEFAULT_CAPACITY, "Unexpected Alice GHO balance after second sell");
        assertEq(USDX_4626_TOKEN.balanceOf(ALICE), 0, "Unexpected Alice USDX balance after second sell");
        assertEq(GHO_GSM_4626.getExposureCap(), DEFAULT_GSM_USDX_EXPOSURE, "Unexpected exposure capacity");
    }
    ...
    function testGetGhoAmountForBuyAsset() public {
        (uint256 exactAssetAmount, uint256 ghoSold, uint256 grossAmount, uint256 fee) =
            GHO_GSM_4626.getGhoAmountForBuyAsset(DEFAULT_GSM_USDX_AMOUNT);
        ...
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM_4626)) - ghoFeesBefore, fee, "Unexpected GHO fee amount");

        (uint256 assetAmount, uint256 exactGhoSold, uint256 grossAmount2, uint256 fee2) =
            GHO_GSM_4626.getAssetAmountForBuyAsset(ghoSold);
        assertEq(ghoBalanceBefore - GHO_TOKEN.balanceOf(ALICE), exactGhoSold, "Unexpected GHO sold exact amount");
    ...
    function testGetGhoAmountForBuyAssetWithZeroFee() public {
        ...
        assertEq(ghoBalanceBefore - GHO_TOKEN.balanceOf(ALICE), ghoSold, "Unexpected GHO sold amount");
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM_4626)), ghoFeesBefore, "Unexpected GHO fee amount");
    ...
    function testGetGhoAmountForBuyAssetWithZeroAmount() public view {
        (uint256 exactAssetAmount, uint256 ghoSold, uint256 grossAmount, uint256 fee) =
            GHO_GSM_4626.getGhoAmountForBuyAsset(0);
        assertEq(exactAssetAmount, 0, "Unexpected exact asset amount");
    ...
    function testConfiguratorUpdateMethods() public {
        ...
        assertEq(GHO_GSM_4626.getFeeStrategy(), address(GHO_GSM_FIXED_FEE_STRATEGY), "Unexpected fee strategy");
        FixedFeeStrategy newFeeStrategy = new FixedFeeStrategy(DEFAULT_GSM_BUY_FEE, DEFAULT_GSM_SELL_FEE);
        vm.expectEmit(true, true, false, true, address(GHO_GSM_4626));
    ...
    function testRescueGhoTokens() public {
        ...
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM_4626)), 100e18, "Unexpected GSM GHO before balance");
    ...
    function testRescueGhoTokensWithAccruedFees() public {
        ...
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM_4626)), fee + 1, "Unexpected GSM GHO balance before");
    ...
    function testRescueUnderlyingTokens() public {
        ...
        assertEq(USDX_4626_TOKEN.balanceOf(ALICE), DEFAULT_GSM_USDX_AMOUNT, "Unexpected USDX balance after");
    }
    ...
    function testRescueUnderlyingTokensWithAccruedFees() public {
        ...
        assertEq(
            USDX_4626_TOKEN.balanceOf(address(GHO_GSM_4626)), currentGSMBalance, "Unexpected GSM USDX balance before"
        );
        ...
        GHO_GSM_4626.rescueTokens(address(USDX_4626_TOKEN), ALICE, DEFAULT_GSM_USDX_AMOUNT);
        assertEq(
            USDX_4626_TOKEN.balanceOf(address(GHO_GSM_4626)), currentGSMBalance, "Unexpected GSM USDX balance after"
        );
        assertEq(USDX_4626_TOKEN.balanceOf(ALICE), DEFAULT_GSM_USDX_AMOUNT, "Unexpected target USDX balance after");
    }
    ...
    function testSeize() public {
        ...
        vm.expectEmit(true, false, false, true, address(GHO_GSM_4626));
        emit Seized(address(GHO_GSM_LAST_RESORT_LIQUIDATOR), BOB, DEFAULT_GSM_USDX_AMOUNT, DEFAULT_GSM_GHO_AMOUNT);
        ...
        assertEq(USDX_4626_TOKEN.balanceOf(TREASURY), DEFAULT_GSM_USDX_AMOUNT, "Unexpected USDX after token balance");
        assertEq(GHO_GSM_4626.getExposureCap(), 0, "Unexpected exposure capacity");
    }
    ...
    function testInjectGho() public {
        ...
        vm.expectEmit(true, true, false, true, address(GHO_GSM_4626));
        emit BackingProvided(BOB, address(GHO_TOKEN), DEFAULT_GSM_GHO_AMOUNT / 2, DEFAULT_GSM_GHO_AMOUNT / 2, 0);
    ...
    function testInjectUnderlying() public {
        ...
        USDX_4626_TOKEN.approve(address(GHO_GSM_4626), DEFAULT_GSM_USDX_AMOUNT);
        vm.expectEmit(true, true, false, true, address(GHO_GSM_4626));
        emit BackingProvided(BOB, address(USDX_4626_TOKEN), DEFAULT_GSM_USDX_AMOUNT, DEFAULT_GSM_GHO_AMOUNT / 2, 0);
    ...
    function testDistributeFeesToTreasury() public {
        ...
        vm.expectEmit(true, true, true, true, address(GHO_GSM_4626));
        emit FeesDistributedToTreasury(TREASURY, address(GHO_TOKEN), GHO_TOKEN.balanceOf(address(GHO_GSM_4626)));

        GHO_GSM_4626.distributeFeesToTreasury();

        assertEq(GHO_GSM_4626.getAccruedFees(), 0, "Unexpected GSM accrued fees");
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM_4626)), 0, "Unexpected GSM GHO balance post-distribution");
    ...
    function testDistributeYieldToTreasuryDoNothing() public {
        ...
        assertEq(GHO_GSM_4626.getAccruedFees(), 0, "Unexpected GSM accrued fees");
        assertEq(
            GHO_TOKEN.balanceOf(address(GHO_GSM_4626)), gsmBalanceBefore, "Unexpected GSM GHO balance post-distribution"
        );
        assertEq(GHO_TOKEN.balanceOf(TREASURY), treasuryBalanceBefore, "Unexpected GHO balance in treasury");
    }
