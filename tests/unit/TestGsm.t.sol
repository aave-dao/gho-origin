...
contract TestGsm is TestGhoBase {
    ...
    function testConstructor() public {
        Gsm gsm = new Gsm(address(GHO_TOKEN), address(USDX_TOKEN), address(GHO_GSM_FIXED_PRICE_STRATEGY));
        ...
        assertEq(gsm.PRICE_STRATEGY(), address(GHO_GSM_FIXED_PRICE_STRATEGY), "Unexpected price strategy");
    ...
    function testInitialize() public {
        ...
        Gsm gsm = _deployGsmProxy(address(USDX_TOKEN), address(GHO_GSM_FIXED_PRICE_STRATEGY), DEFAULT_GSM_USDX_EXPOSURE);
    ...
    function testRevertInitializeZeroAdmin() public {
        Gsm gsmImpl = new Gsm(address(GHO_TOKEN), address(USDX_TOKEN), address(GHO_GSM_FIXED_PRICE_STRATEGY));
    ...
    function testSellAsset() public {
        ...
        assertEq(GHO_GSM.getAvailableLiquidity(), DEFAULT_GSM_USDX_AMOUNT, "Unexpected available liquidity");
        assertEq(GHO_GSM.getExposureCap(), DEFAULT_GSM_USDX_EXPOSURE, "Unexpected exposure capacity");
    }
    ...
    function testSellAssetWithSig() public {
        ...
        vm.prank(ALICE);
        vm.expectEmit(true, true, true, true, address(GHO_GSM));
        emit SellAsset(gsmSignerAddr, gsmSignerAddr, DEFAULT_GSM_USDX_AMOUNT, DEFAULT_GSM_GHO_AMOUNT, fee);
        GHO_GSM.sellAssetWithSig(gsmSignerAddr, DEFAULT_GSM_USDX_AMOUNT, gsmSignerAddr, deadline, signature);
    ...
    function testRevertSellAssetTooMuchUnderlyingExposure() public {
        Gsm gsm = _deployGsmProxy(
            address(USDX_TOKEN), address(GHO_GSM_FIXED_PRICE_STRATEGY), uint128(DEFAULT_GSM_USDX_EXPOSURE - 1)
        );
    ...
    function testGetGhoAmountForSellAsset() public {
        (uint256 exactAssetAmount, uint256 ghoBought, uint256 grossAmount, uint256 fee) =
            GHO_GSM.getGhoAmountForSellAsset(DEFAULT_GSM_USDX_AMOUNT);

        _sellAsset(GHO_GSM, USDX_TOKEN, ALICE, DEFAULT_GSM_USDX_AMOUNT);

        assertEq(
            DEFAULT_GSM_USDX_AMOUNT - USDX_TOKEN.balanceOf(ALICE), exactAssetAmount, "Unexpected asset amount sold"
        );
        ...
        (uint256 assetAmount, uint256 exactGhoBought, uint256 grossAmount2, uint256 fee2) =
            GHO_GSM.getAssetAmountForSellAsset(ghoBought);
    ...
    function testGetGhoAmountForSellAssetWithZeroAmount() public view {
        (uint256 exactAssetAmount, uint256 ghoBought, uint256 grossAmount, uint256 fee) =
            GHO_GSM.getGhoAmountForSellAsset(0);
    ...
    function testBuyAssetSendToOther() public {
        ...
        assertEq(USDX_TOKEN.balanceOf(CHARLES), DEFAULT_GSM_USDX_AMOUNT, "Unexpected final USDX balance");
        assertEq(GHO_TOKEN.balanceOf(ALICE), ghoOut, "Unexpected final GHO balance");
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM)), sellFee + buyFee, "Unexpected GSM GHO balance");
        assertEq(GHO_GSM.getExposureCap(), DEFAULT_GSM_USDX_EXPOSURE, "Unexpected exposure capacity");
    }
    ...
    function testBuyAssetWithSig() public {
        ...
        vm.prank(BOB);
        vm.expectEmit(true, true, true, true, address(GHO_GSM));
        emit BuyAsset(gsmSignerAddr, gsmSignerAddr, DEFAULT_GSM_USDX_AMOUNT, DEFAULT_GSM_GHO_AMOUNT + buyFee, buyFee);
        GHO_GSM.buyAssetWithSig(gsmSignerAddr, DEFAULT_GSM_USDX_AMOUNT, gsmSignerAddr, deadline, signature);

        assertEq(GHO_GSM.nonces(gsmSignerAddr), 1, "Unexpected final gsmSignerAddr nonce");
        assertEq(USDX_TOKEN.balanceOf(gsmSignerAddr), DEFAULT_GSM_USDX_AMOUNT, "Unexpected final USDX balance");
        assertEq(GHO_TOKEN.balanceOf(ALICE), ghoOut, "Unexpected final GHO balance");
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM)), sellFee + buyFee, "Unexpected GSM GHO balance");
        assertEq(GHO_GSM.getExposureCap(), DEFAULT_GSM_USDX_EXPOSURE, "Unexpected exposure capacity");
    }
    ...
    function testGetGhoAmountForBuyAsset() public {
        (uint256 exactAssetAmount, uint256 ghoSold, uint256 grossAmount, uint256 fee) =
            GHO_GSM.getGhoAmountForBuyAsset(DEFAULT_GSM_USDX_AMOUNT);
        ...
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM)) - ghoFeesBefore, fee, "Unexpected GHO fee amount");

        (uint256 assetAmount, uint256 exactGhoSold, uint256 grossAmount2, uint256 fee2) =
            GHO_GSM.getAssetAmountForBuyAsset(ghoSold);
    ...
    function testGetGhoAmountForBuyAssetWithZeroAmount() public view {
        (uint256 exactAssetAmount, uint256 ghoSold, uint256 grossAmount, uint256 fee) =
            GHO_GSM.getGhoAmountForBuyAsset(0);
        assertEq(exactAssetAmount, 0, "Unexpected exact asset amount");
    ...
    function testConfiguratorUpdateMethods() public {
        ...
        assertEq(GHO_GSM.getFeeStrategy(), address(GHO_GSM_FIXED_FEE_STRATEGY), "Unexpected fee strategy");
    ...
    function testRescueUnderlyingTokensWithAccruedFees() public {
        ...
        assertEq(USDX_TOKEN.balanceOf(address(GHO_GSM)), currentGSMBalance, "Unexpected GSM USDX balance before");
        ...
        emit TokensRescued(address(USDX_TOKEN), ALICE, DEFAULT_GSM_USDX_AMOUNT);
        GHO_GSM.rescueTokens(address(USDX_TOKEN), ALICE, DEFAULT_GSM_USDX_AMOUNT);
        assertEq(USDX_TOKEN.balanceOf(address(GHO_GSM)), currentGSMBalance, "Unexpected GSM USDX balance after");
        assertEq(USDX_TOKEN.balanceOf(ALICE), DEFAULT_GSM_USDX_AMOUNT, "Unexpected target USDX balance after");
    }
    ...
    function testSeize() public {
        ...
        assertEq(USDX_TOKEN.balanceOf(TREASURY), DEFAULT_GSM_USDX_AMOUNT, "Unexpected USDX after token balance");
        assertEq(GHO_GSM.getAvailableLiquidity(), 0, "Unexpected available liquidity");
        assertEq(GHO_GSM.getAvailableUnderlyingExposure(), 0, "Unexpected underlying exposure available");
        assertEq(GHO_GSM.getExposureCap(), 0, "Unexpected exposure capacity");
    }
    ...
    function testDistributeFeesToTreasury() public {
        ...
        vm.expectEmit(true, true, true, true, address(GHO_GSM));
        emit FeesDistributedToTreasury(TREASURY, address(GHO_TOKEN), GHO_TOKEN.balanceOf(address(GHO_GSM)));
        GHO_GSM.distributeFeesToTreasury();
        assertEq(GHO_TOKEN.balanceOf(address(GHO_GSM)), 0, "Unexpected GSM GHO balance post-distribution");
    ...
    function testDistributeYieldToTreasuryDoNothing() public {
        ...
        assertEq(GHO_GSM.getAccruedFees(), 0, "Unexpected GSM accrued fees");
        assertEq(
            GHO_TOKEN.balanceOf(address(GHO_GSM)), gsmBalanceBefore, "Unexpected GSM GHO balance post-distribution"
        );
