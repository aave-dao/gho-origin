...
contract TestGhoAaveSteward is TestGhoBase, GhoStewardProcedure {
    ...
    IGhoAaveSteward.BorrowRateConfig public defaultBorrowRateConfig = IGhoAaveSteward.BorrowRateConfig({
    ...
    IDefaultInterestRateStrategyV2.InterestRateData public defaultRateParams =
        IDefaultInterestRateStrategyV2.InterestRateData({
            optimalUsageRatio: 1_00, baseVariableBorrowRate: 0.2e4, variableRateSlope1: 0, variableRateSlope2: 0
        });
    ...
    function setUp() public {
        ...
        DefaultReserveInterestRateStrategyV2 newRateStrategy =
            new DefaultReserveInterestRateStrategyV2(address(PROVIDER));
        CONFIGURATOR.setReserveInterestRateStrategyAddress(
            address(GHO_TOKEN), address(newRateStrategy), abi.encode(defaultRateParams)
        );
    ...
    function testRevertConstructorInvalidOwner() public {
        ...
        new GhoAaveSteward(
            address(0), address(0x002), address(0x003), address(0x004), address(0x005), defaultBorrowRateConfig
        );
    }
    ...
    function testRevertConstructorInvalidAddressesProvider() public {
        ...
        new GhoAaveSteward(
            address(0x001), address(0), address(0x003), address(0x004), address(0x005), defaultBorrowRateConfig
        );
    }
    ...
    function testRevertConstructorInvalidDataProvider() public {
        ...
        new GhoAaveSteward(
            address(0x001), address(0x002), address(0), address(0x004), address(0x005), defaultBorrowRateConfig
        );
    }
    ...
    function testRevertConstructorInvalidGhoToken() public {
        ...
        new GhoAaveSteward(
            address(0x001), address(0x002), address(0x003), address(0), address(0x005), defaultBorrowRateConfig
        );
    }
    ...
    function testRevertConstructorInvalidRiskCouncil() public {
        ...
        new GhoAaveSteward(
            address(0x001), address(0x002), address(0x003), address(0x004), address(0), defaultBorrowRateConfig
        );
    }
    ...
    function testRevertUpdateGhoBorrowRateOptimalUsageRatioIfMaxExceededUpwards() public {
        uint16 oldOptimalUsageRatio = _getOptimalUsageRatio();
        uint16 newOptimalUsageRatio = oldOptimalUsageRatio + defaultBorrowRateConfig.optimalUsageRatioMaxChange + 1;
        vm.prank(RISK_COUNCIL);
    ...
    function testRevertUpdateGhoBorrowRateOptimalUsageRatioIfMaxExceededDownwards() public {
        uint16 oldOptimalUsageRatio = _getOptimalUsageRatio();
        uint16 newOptimalUsageRatio = oldOptimalUsageRatio + defaultBorrowRateConfig.optimalUsageRatioMaxChange;
        vm.prank(RISK_COUNCIL);
        GHO_AAVE_STEWARD.updateGhoBorrowRate(
            newOptimalUsageRatio,
            defaultRateParams.baseVariableBorrowRate,
    ...
    function testRevertUpdateGhoBorrowRateVariableRateSlope1IfMaxExceededUpwards() public {
        uint32 oldVariableRateSlope1 = _getVariableRateSlope1();
        uint32 newVariableRateSlope1 = oldVariableRateSlope1 + defaultBorrowRateConfig.variableRateSlope1MaxChange + 1;
        vm.prank(RISK_COUNCIL);
    ...
    function testRevertUpdateGhoBorrowRateVariableRateSlope1IfMaxExceededDownwards() public {
        uint32 oldVariableRateSlope1 = _getVariableRateSlope1();
        uint32 newVariableRateSlope1 = oldVariableRateSlope1 + defaultBorrowRateConfig.variableRateSlope1MaxChange;
        ...
        vm.warp(block.timestamp + GHO_AAVE_STEWARD.MINIMUM_DELAY() + 1);
        GHO_AAVE_STEWARD.updateGhoBorrowRate(
            defaultRateParams.optimalUsageRatio, ghoBorrowRate, newVariableRateSlope1, newVariableRateSlope1
        );
        vm.warp(block.timestamp + GHO_AAVE_STEWARD.MINIMUM_DELAY() + 1);
        vm.expectRevert("INVALID_VARIABLE_RATE_SLOPE1");
        GHO_AAVE_STEWARD.updateGhoBorrowRate(
    ...
    function testRevertUpdateGhoBorrowRateVariableRateSlope2IfMaxExceededUpwards() public {
        uint32 oldVariableRateSlope2 = _getVariableRateSlope2();
        uint32 newVariableRateSlope2 = oldVariableRateSlope2 + defaultBorrowRateConfig.variableRateSlope2MaxChange + 1;
        vm.prank(RISK_COUNCIL);
    ...
    function testRevertUpdateGhoBorrowRateVariableRateSlope2IfMaxExceededDownwards() public {
        uint32 oldVariableRateSlope2 = _getVariableRateSlope2();
        uint32 newVariableRateSlope2 = oldVariableRateSlope2 + defaultBorrowRateConfig.variableRateSlope2MaxChange;
    ...
    function testSetRiskConfig() public {
        ...
        IGhoAaveSteward.BorrowRateConfig memory currentBorrowRateConfig = GHO_AAVE_STEWARD.getBorrowRateConfig();
        assertEq(currentBorrowRateConfig.optimalUsageRatioMaxChange, defaultBorrowRateConfig.optimalUsageRatioMaxChange);
    }
    ...
    function _getGhoBorrowCap() internal view returns (uint256) {
        DataTypes.ReserveConfigurationMap memory configuration = POOL.getConfiguration(address(GHO_TOKEN));
    ...
    function _setGhoBorrowRateViaConfigurator(uint32 newBorrowRate) internal {
        IDefaultInterestRateStrategyV2.InterestRateData memory rateParams =
            IDefaultInterestRateStrategyV2.InterestRateData({
    ...
    function _getGhoBorrowRate() internal view returns (uint32) {
        address currentInterestRateStrategy = POOL.getReserveInterestRateStrategyAddress(address(GHO_TOKEN));
        return uint32(
            IDefaultInterestRateStrategyV2(currentInterestRateStrategy).getBaseVariableBorrowRate(address(GHO_TOKEN))
                / 1e23
        ); // Convert to bps
    }
    ...
    function _getOptimalUsageRatio() internal view returns (uint16) {
        address currentInterestRateStrategy = POOL.getReserveInterestRateStrategyAddress(address(GHO_TOKEN));
        return uint16(
            IDefaultInterestRateStrategyV2(currentInterestRateStrategy).getOptimalUsageRatio(address(GHO_TOKEN)) / 1e23
        ); // Convert to bps
    }
    ...
    function _getVariableRateSlope1() internal view returns (uint32) {
        address currentInterestRateStrategy = POOL.getReserveInterestRateStrategyAddress(address(GHO_TOKEN));
        return uint32(
            IDefaultInterestRateStrategyV2(currentInterestRateStrategy).getVariableRateSlope1(address(GHO_TOKEN)) / 1e23
        ); // Convert to bps
    }
    ...
    function _getVariableRateSlope2() internal view returns (uint32) {
        address currentInterestRateStrategy = POOL.getReserveInterestRateStrategyAddress(address(GHO_TOKEN));
        return uint32(
            IDefaultInterestRateStrategyV2(currentInterestRateStrategy).getVariableRateSlope2(address(GHO_TOKEN)) / 1e23
        ); // Convert to bps
    }
}
